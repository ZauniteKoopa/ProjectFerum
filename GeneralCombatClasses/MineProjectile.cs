...
public class MineProjectile : AttackBox
{
    ...
    public void offensiveSetup(float speed, float kb, int priority, IMove move) {
        ...
        deploy.GetComponent<PoisonCloud>().offensiveSetup(move.getBasis()); //TO BE CHANGED!!! GENERALIZE INTO INTERFACE
    }
    ...
    IEnumerator destroyProj() {
        ...
        deploy.GetComponent<PoisonCloud>().activate();
